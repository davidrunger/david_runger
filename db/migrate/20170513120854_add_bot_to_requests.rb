require_relative "#{Rails.root}/db/datamigrate/destroy_requests_without_user_agent.rb"
require_relative "#{Rails.root}/db/datamigrate/copy_bot_from_user_agent_string_to_new_column.rb"
