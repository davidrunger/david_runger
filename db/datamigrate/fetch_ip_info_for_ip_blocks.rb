Rails.logger.info("Starting datamigration #{__FILE__.delete_prefix(Rails.root.join('').to_s)} .")
...
Rails.logger.info("Datamigration #{__FILE__.delete_prefix(Rails.root.join('').to_s)} complete.")
